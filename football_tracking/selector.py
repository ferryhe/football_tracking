...
class UniqueBallSelector:
    ...
    def __init__(self, config: SelectionConfig, tracking_config: TrackingConfig) -> None:
        self.config = config
        self.tracking_config = tracking_config

    def select(self, candidates: list[Candidate], context: TrackerContext) -> SelectionDecision:
        if not candidates:
        ...
        scored_candidates = [self._score_candidate(candidate, context) for candidate in candidates]
    ...
    def _score_candidate(self, candidate: Candidate, context: TrackerContext) -> CandidateScore:
