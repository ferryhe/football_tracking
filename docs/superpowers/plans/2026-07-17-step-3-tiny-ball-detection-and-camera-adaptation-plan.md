...
**Status:** Execution active · PR-T3H complete · PR-T3I publication active · PR-T4 held at the feasibility gate
...
- Current PR: PR-T3I · Step 3 operator controls, truthful gate, and recovery guidance
- Current branch: `codex/tiny-ball-step3-operator-controls` from `main` at `abcaf6eacb731629cb05b04e5347820cca8263c8`
- Current phase: PR-T3H product and docs-only closeout PRs are merged and cleaned. PR-T3I product PR #126 is open; one valid Chromium test-locator regression is fixed and locally green, and the corrective push will restart Node/Python CI and the complete 10-minute feedback window. PR-T4 remains unauthorized.
...
| PR-T3I | `codex/tiny-ball-step3-operator-controls` | open · one valid CI locator regression fixed · replacement CI/push pending · spec COMPLIANT · quality/security APPROVE · PR-T4 remains unauthorized | https://github.com/ferryhe/football_tracking/pull/126 | restarts after corrective push | pending |
