...
- Current phase: PR-T1 and PR-T2 merged and cleaned up · PR-T3 is open as GitHub PR #114 · specification review is COMPLIANT · frontend, backend security, and final whole-diff reviews are APPROVE · the honest real-video result remains sealed as `insufficient_evidence` with every downstream authorization false · replacement run `29693960109` passed Node and exposed four Python portability/determinism cases now repaired · the current-diff official Python route is green · the second replacement CI and the reset 10-minute feedback window remain required before merge
...
| PR-T3 | `codex/tiny-ball-annotation-feasibility` | open · run `29693960109` Node passed/Python failed 2+2 · scoped repair and full local route passed · spec COMPLIANT · frontend/backend/final quality APPROVE · second replacement CI pending | https://github.com/ferryhe/football_tracking/pull/114 | reset window 2026-07-19T16:48:00Z–16:58:00Z | pending |
