...
- Current phase: PR-T3H is published as GitHub PR #124. Local and independent gates pass; GitHub Node/Python CI is running. A status-only publication checkpoint will be the final material push and restarts the required 10-minute remote-feedback window. PR-T3I remains queued; PR-T4 remains unauthorized.
...
| PR-T3H | `codex/tiny-ball-probe-lineage-compatibility` | PR #124 open · spec COMPLIANT · quality/security APPROVE · local gates passed · Node/Python CI running · PR-T4 remains unauthorized | https://github.com/ferryhe/football_tracking/pull/124 | restarts after publication-status push | pending |
