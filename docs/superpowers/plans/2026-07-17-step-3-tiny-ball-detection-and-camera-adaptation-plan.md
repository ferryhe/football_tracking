...
- Current phase: PR-T3H product and docs-only closeout PRs are merged and cleaned. PR-T3I product PR #126 is open and MERGEABLE; Node/Python CI and the complete 10-minute feedback window after the final status push are required before merge. PR-T4 remains unauthorized.
...
| PR-T3I | `codex/tiny-ball-step3-operator-controls` | open · Node/Python CI running · spec COMPLIANT · quality/security APPROVE · PR-T4 remains unauthorized | https://github.com/ferryhe/football_tracking/pull/126 | starts after final status push | pending |
