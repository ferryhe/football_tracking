...
const enCopy = {
  ...
  workspace: {
    ...
    fieldSetupSubtitle:
      "Generate one field suggestion under the selected clip, adjust it if needed, then accept it before the baseline run.",
    ...
    fieldEmptyBody: "Generate one suggestion first, then review the overlay here.",
    ...
    baselineSubtitle: "Pick the starting YAML. If it already contains field setup, the preview above will follow it.",
...
const zhCopy: Copy = {
  ...
  workspace: {
    ...
    fieldSetupSubtitle: "先为当前视频生成球场建议，必要时微调，确认后再开始基线运行。",
    ...
    baselineTitle: "基线配置",
    baselineSubtitle: "选择起始 YAML。如果 YAML 自带球场设置，上面的预览会同步更新。",
