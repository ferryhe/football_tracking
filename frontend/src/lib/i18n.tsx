...
const enCopy = {
  ...
  workspace: {
    ...
    focusSubtitle: "This focused run is the evidence source for both AI and review.",
    ...
    noFocusBody: "Run one baseline to unlock the evidence lane.",
    queueEyebrow: "Run history",
    queueTitle: "Recent runs",
    queueSubtitle: "Use this list to switch focus. Keep logs secondary.",
    deliveryEyebrow: "Delivery",
    deliveryTitle: "Final runs",
    deliverySubtitle: "Use this list for handoff. If a run is not good enough, go back to AI.",
    deliveryEmptyTitle: "No delivery runs yet",
    deliveryEmptyBody: "Finish one run first, then the result folder will show here.",
...
const zhCopy: Copy = {
  ...
  header: {
    eyebrow: "AI 流程台",
    title: "足球跟踪控制台",
    subtitle: "先手动跑一版基线，后面的配置迭代交给 AI 基于证据来做。",
    activeTask: "当前任务",
    inputRoot: "输入目录",
    language: "语言",
    tileInput: "输入",
  ...
  workspace: {
    ...
    flowChooseDetail: "人工步骤。选输入视频和起始配置。",
    flowRunTitle: "跑一版基线",
    flowRunDetail: "人工步骤。先跑一次，拿到第一份证据包。",
    flowAiTitle: "AI 建议改动",
    flowAiDetail: "AI 读取证据，解释问题，并生成下一版配置补丁。",
    flowReviewTitle: "检查输出",
    flowReviewDetail: "人工步骤。看输出、决定接受还是再跑。",
    selectEyebrow: "人工操作",
    selectTitle: "先选视频，再启动一次",
    selectSubtitle: "这里只处理输入和首版基线。后面的调参建议应该交给 AI。",
    inputTitle: "输入视频",
    ...
    launchCopy: "先跑一版基线。之后的配置改动让 AI 来建议。",
    launchButton: "启动基线",
    launchStarting: "启动中...",
    launchHint: "第一版之后就尽量不要手改参数，让 AI 来给建议。",
    focusEyebrow: "当前证据",
    focusTitle: "始终只盯一个 run",
    focusSubtitle: "这个焦点 run 是 AI 和人工复核共同使用的证据来源。",
    currentFocus: "焦点 run",
    focusRun: "焦点 run",
    aiLane: "AI 角色",
    ...
    noFocusBody: "先跑一版基线，才能打开证据通道。",
    queueEyebrow: "运行历史",
    queueTitle: "最近运行",
    queueSubtitle: "这里只用来切换焦点，不用堆详细日志。",
    deliveryEyebrow: "交付",
    deliveryTitle: "最终运行",
    deliverySubtitle: "这里按时间看结果。要是结果不够好，就回到 AI 步骤。",
    deliveryEmptyTitle: "还没有交付运行",
    deliveryEmptyBody: "先完成一次运行，这里才会出现结果 folder。",
    deliveryRanAt: "运行时间",
