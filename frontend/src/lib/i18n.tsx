...
const enCopy = {
  ...
  workspace: {
    ...
    heroTitle: "Main controls stay at the top",
    heroSubtitle: "Choose input, launch baseline, inspect output, then ask AI for the next config.",
    statInputs: "Input clips",
    statPulse: "Pulse",
...
const zhCopy: Copy = {
  ...
  header: {
    eyebrow: "AI 工作台",
    title: "足球跟踪控制台",
    subtitle: "选一条视频，跑一次基线，再让 AI 基于证据继续迭代。",
    activeTask: "当前任务",
    inputRoot: "输入目录",
    language: "语言",
    tileInput: "输入",
  ...
  workspace: {
    heroEyebrow: "工作区",
    heroTitle: "把主要操作放在最上面",
    heroSubtitle: "选输入、跑基线、看结果，再让 AI 推荐下一版配置。",
    statInputs: "输入视频",
    statPulse: "系统状态",
    statBaselines: "可用基线",
    selectEyebrow: "输入 + 基线",
    selectTitle: "先选视频和配置",
    selectSubtitle: "第一步保持收敛：一条视频、一份基线、一次干净启动。",
    inputTitle: "输入视频",
    inputSubtitle: "自动发现 `data/` 目录下的源视频。",
    inputDirectory: "输入目录",
    noInputTitle: "还没有视频",
    ...
    launchCopy: "这次会直接启动带 cleanup 和 follow-cam 的基线 run，方便 AI 从真实产物继续迭代。",
    launchButton: "启动基线",
    launchStarting: "启动中...",
    focusEyebrow: "焦点运行",
    focusTitle: "保持一个 run 在焦点里",
    ...
    noFocusBody: "先启动一次基线，才能解锁证据区。",
    queueEyebrow: "队列",
    queueTitle: "最近运行",
    queueSubtitle: "这里只保留短列表，详细日志继续放在次级层。",
    runningNow: "当前运行",
    noRunsTitle: "还没有运行记录",
