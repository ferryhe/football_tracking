...
const enCopy = {
  ...
  workspace: {
    ...
    flowDeliverableTitle: "Deliverable task",
    flowDeliverableDetail: "Create a clean 16:9 export from a completed run.",
    flowHistoryTitle: "History",
    flowHistoryDetail: "Review past runs and clean old videos or YAML files.",
    ...
    deliverableEyebrow: "Step 3",
    deliverableTitle: "Deliverable task",
    deliverableSubtitle: "Reuse a completed run and export a clean 16:9 deliverable.",
    historyEyebrow: "Step 4",
    historyTitle: "History",
    historySubtitle: "All past runs across every source clip.",
...
const zhCopy: Copy = {
  ...
  workspace: {
    ...
    flowDeliverableTitle: "成品任务",
    flowDeliverableDetail: "基于已完成结果单独导出干净的 16:9 成品。",
    flowHistoryTitle: "历史",
    flowHistoryDetail: "查看过往运行，并清理不再需要的视频或 YAML。",
    ...
    deliverableEyebrow: "第三步",
    deliverableTitle: "成品任务",
    deliverableSubtitle: "复用已完成 run，单独导出干净的 16:9 成品。",
    historyEyebrow: "第四步",
    historyTitle: "历史",
    historySubtitle: "查看所有视频的过往运行结果。",
