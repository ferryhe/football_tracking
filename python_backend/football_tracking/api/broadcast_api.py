...
def build_review_action_envelope(
    ...
    *,
    ...
    present_optional = [
        output_name for output_name, source_name in optional_binding_fields.items() if source_name in queue_bindings
    ]
    ...
    binding_fields.update({output_name: optional_binding_fields[output_name] for output_name in present_optional})
