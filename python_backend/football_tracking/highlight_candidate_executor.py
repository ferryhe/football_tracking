...
def _write_highlight_report(
    ...
    *,
    ...
    payload = {
        ...
        "render_window": validation.get("render_window"),
        "core_window": validation.get("core_window"),
        "core_window_preserved": validation.get("core_window_preserved"),
...
def _candidate_manifest(
    ...
    *,
    ...
    return {
        ...
        "core_window": comparison.get("core_window"),
        "core_window_preserved": comparison.get("core_window_preserved"),
        "required_tail_frames": comparison.get("required_tail_frames"),
        "actual_tail_frames": comparison.get("actual_tail_frames"),
